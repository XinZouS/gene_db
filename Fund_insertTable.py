...
sqlFormula = "INSERT INTO research_Funds (" + colum_names + ") VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
...
for r in range(8, sheet.max_row + 1): # (2, sheet.max_row + 1), row and col in Excel starts at 1
	...
	SubRate	= toFloat_3(sheet.cell(r,	17).value)
	SubAlloc= toFloat_3(sheet.cell(r,	18).value)
	...
	MgrTenL	= toFloat_3(sheet.cell(r,	25).value)
	MgrTenA	= toFloat_3(sheet.cell(r,	26).value)
	PrBench	= sheet.cell(r,	27).value
	MgtFee	= toFloat_3(sheet.cell(r,	28).value)
	CashP	= toFloat_2(sheet.cell(r,	29).value)
	TurnRate	= toFloat_3(sheet.cell(r,	30).value)
	...
	Yld12M	= toFloat_5(sheet.cell(r,	43).value)
	SECYld	= toFloat_3(sheet.cell(r,	44).value)
	AS201809	= toFloat_3(sheet.cell(r,	45).value)
	AS201712	= toFloat_3(sheet.cell(r,	46).value)
	AS201612	= toFloat_3(sheet.cell(r,	47).value)
	AS201512	= toFloat_3(sheet.cell(r,	48).value)
	AS201412	= toFloat_3(sheet.cell(r,	49).value)
	AS201312	= toFloat_3(sheet.cell(r,	50).value)
	AS201212	= toFloat_3(sheet.cell(r,	51).value)
	AS201112	= toFloat_3(sheet.cell(r,	52).value)
	AS201012	= toFloat_3(sheet.cell(r,	53).value)
	AS200912	= toFloat_3(sheet.cell(r,	54).value)
	AS200812	= toFloat_3(sheet.cell(r,	55).value)
	AS200712	= toFloat_3(sheet.cell(r,	56).value)
	AS200612	= toFloat_3(sheet.cell(r,	57).value)
	AS200512	= toFloat_3(sheet.cell(r,	58).value)
	AS200412	= toFloat_3(sheet.cell(r,	59).value)
	AS200312	= toFloat_3(sheet.cell(r,	60).value)
	NFYTD	= toFloat_3(sheet.cell(r,	61).value)
	NF3M	= toFloat_3(sheet.cell(r,	62).value)
	MF6M	= toFloat_3(sheet.cell(r,	63).value)
	NF1Y	= toFloat_3(sheet.cell(r,	64).value)
	NF2Y	= toFloat_3(sheet.cell(r,	65).value)
	NF3Y	= toFloat_3(sheet.cell(r,	66).value)
	NF4Y	= toFloat_3(sheet.cell(r,	67).value)
	NF5Y	= toFloat_3(sheet.cell(r,	68).value)
	NF10Y	= toFloat_3(sheet.cell(r,	69).value)
	NF15Y	= toFloat_3(sheet.cell(r,	70).value)
	NF2017	= toFloat_3(sheet.cell(r,	71).value)
	NF2016	= toFloat_3(sheet.cell(r,	72).value)
	NF2015	= toFloat_3(sheet.cell(r,	73).value)
	NF2014	= toFloat_3(sheet.cell(r,	74).value)
	NF2013	= toFloat_3(sheet.cell(r,	75).value)
	NF2012	= toFloat_3(sheet.cell(r,	76).value)
	NF2011	= toFloat_3(sheet.cell(r,	77).value)
	NF2010	= toFloat_3(sheet.cell(r,	78).value)
	NF2009	= toFloat_3(sheet.cell(r,	79).value)
	NF2008	= toFloat_3(sheet.cell(r,	80).value)
	NF2007	= toFloat_3(sheet.cell(r,	81).value)
	NF2006	= toFloat_3(sheet.cell(r,	82).value)
	NF2005	= toFloat_3(sheet.cell(r,	83).value)
	NF2004	= toFloat_3(sheet.cell(r,	84).value)
	NF2003	= toFloat_3(sheet.cell(r,	85).value)
	...
	APAUM	= toFloat_3(sheet.cell(r,	123).value)
	AP201809	= toFloat_3(sheet.cell(r,	124).value)
	AP201712	= toFloat_3(sheet.cell(r,	125).value)
	AP201612	= toFloat_3(sheet.cell(r,	126).value)
	AP201512	= toFloat_3(sheet.cell(r,	127).value)
	AP201412	= toFloat_3(sheet.cell(r,	128).value)
	AP201312	= toFloat_3(sheet.cell(r,	129).value)
	AP201212	= toFloat_3(sheet.cell(r,	130).value)
	AP201112	= toFloat_3(sheet.cell(r,	131).value)
	AP201012	= toFloat_3(sheet.cell(r,	132).value)
	AP200912	= toFloat_3(sheet.cell(r,	133).value)
	AP200812	= toFloat_3(sheet.cell(r,	134).value)
	AP200712	= toFloat_3(sheet.cell(r,	135).value)
	AP200612	= toFloat_3(sheet.cell(r,	136).value)
	AP200512	= toFloat_3(sheet.cell(r,	137).value)
	AP200412	= toFloat_3(sheet.cell(r,	138).value)
	AP200312	= toFloat_3(sheet.cell(r,	139).value)
	NFPYTD	= toFloat_3(sheet.cell(r,	140).value)
	NFP3M	= toFloat_3(sheet.cell(r,	141).value)
	NFP6M	= toFloat_3(sheet.cell(r,	142).value)
	NFP1Y	= toFloat_3(sheet.cell(r,	143).value)
	NFP2Y	= toFloat_3(sheet.cell(r,	144).value)
	NFP3Y	= toFloat_3(sheet.cell(r,	145).value)
	NFP4Y	= toFloat_3(sheet.cell(r,	146).value)
	NFP5Y	= toFloat_3(sheet.cell(r,	147).value)
	NFP10Y	= toFloat_3(sheet.cell(r,	148).value)
	NFP15Y	= toFloat_3(sheet.cell(r,	149).value)
	NFP2017	= toFloat_3(sheet.cell(r,	150).value)
	NFP2016	= toFloat_3(sheet.cell(r,	151).value)
	NFP2015	= toFloat_3(sheet.cell(r,	152).value)
	NFP2014	= toFloat_3(sheet.cell(r,	153).value)
	NFP2013	= toFloat_3(sheet.cell(r,	154).value)
	NFP2012	= toFloat_3(sheet.cell(r,	155).value)
	NFP2011	= toFloat_3(sheet.cell(r,	156).value)
	NFP2010	= toFloat_3(sheet.cell(r,	157).value)
	NFP2009	= toFloat_3(sheet.cell(r,	158).value)
	NFP2008	= toFloat_3(sheet.cell(r,	159).value)
	NFP2007	= toFloat_3(sheet.cell(r,	160).value)
	NFP2006	= toFloat_3(sheet.cell(r,	161).value)
	NFP2005	= toFloat_3(sheet.cell(r,	162).value)
	NFP2004	= toFloat_3(sheet.cell(r,	163).value)
	NFP2003	= toFloat_3(sheet.cell(r,	164).value)
	...
	SubRateP	= toFloat_3(sheet.cell(r,	169).value)
	Platform	= sheet.cell(r,	170).value
	Platcnt	= sheet.cell(r,	171).value
	valgro2	= toFloat_4(sheet.cell(r,	172).value)
	smlrg2	= toFloat_4(sheet.cell(r,	173).value)
	valgro3	= toFloat_4(sheet.cell(r,	174).value)
	smlrg3	= toFloat_4(sheet.cell(r,	175).value)
	valgro5	= toFloat_4(sheet.cell(r,	176).value)
	smlrg5	= toFloat_4(sheet.cell(r,	177).value)
	AdvPar	= sheet.cell(r,	178).value
	SAdvPar	= sheet.cell(r,	179).value
	MandID	= sheet.cell(r,	180).value
	SubDollr= toFloat_3(sheet.cell(r,	181).value)
